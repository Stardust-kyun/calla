...
# Change Bar
sed -i 's/bg = .*/bg = #fefefe/g' $POLY/Arch/config.ini
sed -i 's/fg = .*/fg = #111111/g' $POLY/Arch/config.ini
sed -i 's/fg-alt = .*/fg-alt = #787878/g' $POLY/Arch/config.ini
...
# Change Notifs
sed -i 's/background = .*/background = "#fefefe"/g' $NOTI/dunstrc
sed -i 's/foreground = .*/foreground = "#111111"/g' $NOTI/dunstrc
...
# Change Xresources
sed -i 's/#define FG .*/#define FG #464646/g' $HOME/.Xresources
sed -i 's/#define BG .*/#define BG #fefefe/g' $HOME/.Xresources
...
sed -i 's/dmenu.background: .*/dmenu.background: #fefefe/g' $HOME/.Xresources
sed -i 's/dmenu.foreground: .*/dmenu.foreground: #787878/g' $HOME/.Xresources
sed -i 's/dmenu.selbackground: .*/dmenu.selbackground: #fefefe/g' $HOME/.Xresources
sed -i 's/dmenu.selforeground: .*/dmenu.selforeground: #111111/g' $HOME/.Xresources

# Change Alacritty
sed -i 's/.*#BG/    "#fefefe" #BG/g' $ALAC/alacritty.yml
sed -i 's/.*#FG/    "#464646" #FG/g' $ALAC/alacritty.yml
...
sed -i 's/foreground .*/foreground #464646/g' $KITTY/kitty.conf
sed -i 's/background .*/background #fefefe/g' $KITTY/kitty.conf
sed -i 's/selection_foreground .*/selection_foreground #fefefe/g' $KITTY/kitty.conf
sed -i 's/selection_background .*/selection_background #464646/g' $KITTY/kitty.conf
sed -i 's/cursor .*/cursor #464646/g' $KITTY/kitty.conf

# Change Vim
sed -i 's/ bg = .*/ bg = "#fefefe"/g' $VIM/colors/theme.vim
sed -i 's/ fg = .*/ fg = "#464646"/g' $VIM/colors/theme.vim
...
# Change Rofi
sed -i 's/--bg: .*/--bg: #fefefe;/g' $ROFI/theme.rasi
sed -i 's/--fg: .*/--fg: #787878;/g' $ROFI/theme.rasi
sed -i 's/--selbg: .*/--selbg: #fefefe;/g' $ROFI/theme.rasi
sed -i 's/--selfg: .*/--selfg: #111111;/g' $ROFI/theme.rasi

# Change GTK
sed -i 's/gtk-theme-name=.*/gtk-theme-name=ArchLight/g' $GTK3/settings.ini
sed -i 's/gtk-theme-name=.*/gtk-theme-name="ArchLight"/g' $HOME/.gtkrc-2.0
...
sed -i 's/Net\/ThemeName .*/Net\/ThemeName "ArchLight"/g' $HOME/.xsettingsd
...
# Change Powercord
sed -i 's/--background-primary: .*/--background-primary: #FEFEFE !important;/g' $CORD/discord.theme.css
sed -i 's/--background-secondary: .*/--background-secondary: #FEFEFE !important;/g' $CORD/discord.theme.css
sed -i 's/--background-secondary-alt: .*/--background-secondary-alt: #FEFEFE !important;/g' $CORD/discord.theme.css
sed -i 's/--background-tertiary: .*/--background-tertiary: #FEFEFE !important;/g' $CORD/discord.theme.css
sed -i 's/--background-accent: .*/--background-accent: #FEFEFE !important;/g' $CORD/discord.theme.css
sed -i 's/--background-floating: .*/--background-floating: #FEFEFE !important;/g' $CORD/discord.theme.css
...
# Change Zathura
sed -i 's/recolor-lightcolor.*/recolor-lightcolor		"#fefefe"/g' $ZATH/zathurarc
sed -i 's/recolor-darkcolor.*/recolor-darkcolor		"#464646"/g' $ZATH/zathurarc
sed -i 's/statusbar-bg.*/statusbar-bg		"#fefefe"/g' $ZATH/zathurarc
sed -i 's/statusbar-fg.*/statusbar-fg		"#464646"/g' $ZATH/zathurarc
sed -i 's/default-bg.*/default-bg			"#fefefe"/g' $ZATH/zathurarc
sed -i 's/default-fg.*/default-fg			"#464646"/g' $ZATH/zathurarc
sed -i 's/inputbar-bg.*/inputbar-bg			"#fefefe"/g' $ZATH/zathurarc
sed -i 's/inputbar-fg.*/inputbar-fg			"#464646"/g' $ZATH/zathurarc
sed -i 's/completion-bg.*/completion-bg		"#fefefe"/g' $ZATH/zathurarc
sed -i 's/completion-fg.*/completion-fg		"#464646"/g' $ZATH/zathurarc
sed -i 's/completion-highlight-bg.*/completion-highlight-bg	"#464646"/g' $ZATH/zathurarc
sed -i 's/completion-highlight-fg.*/completion-highlight-fg	"#fefefe"/g' $ZATH/zathurarc
sed -i 's/completion-group-bg.*/completion-group-bg		"#fefefe"/g' $ZATH/zathurarc
sed -i 's/completion-group-fg.*/completion-group-fg		"#464646"/g' $ZATH/zathurarc

# Change i3lock
sed -i 's/text=".*/text="fefefe"/g' $CONF/bin/lock.sh
sed -i 's/back=".*/back="464646"/g' $CONF/bin/lock.sh
...
# Change Theme
sed -i 's/<theme><name>.*/<theme><name>ArchLight<\/name>/g' $OBOX/rc.xml
