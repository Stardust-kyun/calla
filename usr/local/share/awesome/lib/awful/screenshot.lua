...
-- 
--
--<object class=&#34img-object&#34 data=&#34../images/AUTOGEN_awful_screenshot_keybindings1.svg&#34 alt=&#34Usage example&#34 type=&#34image/svg+xml&#34></object>
--
-- 
...
--             ss:connect_signal(&#34file::saved&#34, notify)
--         else
--             notify(ss)
--         end
--          
...
--             title   = &#34Screenshot in:&#34,
--             message = tostring(args.auto_save_delay) .. &#34 seconds&#34
--         }
--          
--         ss:connect_signal(&#34timer::tick&#34, function(_, remain)
--             notif.message = tostring(remain) .. &#34 seconds&#34
--         end)
--          
--         ss:connect_signal(&#34timer::timeout&#34, function()
...
--     end
--      
--     client.connect_signal(&#34request::default_keybindings&#34, function()
--         awful.keyboard.append_client_keybindings({
--             awful.key({modkey}, &#34Print&#34,
--                 function (c) saved_screenshot { auto_save_delay = 0, client = c } end ,
--                 {description = &#34take client screenshot&#34, group = &#34client&#34}),
--             awful.key({modkey, &#34Shift&#34}, &#34Print&#34,
--                 function (c) saved_screenshot { auto_save_delay = 0, interactive = true, client = c } end ,
--                 {description = &#34take interactive client screenshot&#34, group = &#34client&#34}),
--             awful.key({modkey, &#34Control&#34}, &#34Print&#34,
--                 function (c) delayed_screenshot { auto_save_delay = 5, client = c } end ,
--                 {description = &#34take screenshot in 5 seconds&#34, group = &#34client&#34}),
--             awful.key({modkey, &#34Shift&#34, &#34Control&#34}, &#34Print&#34,
--                 function (c) delayed_screenshot { auto_save_delay = 5, interactive = true, client = c } end ,
--                 {description = &#34take interactive screenshot in 5 seconds&#34, group = &#34client&#34}),
--         })
--     end)
--      
--     awful.keyboard.append_global_keybindings({
--         awful.key({}, &#34Print&#34,
--             function () saved_screenshot { auto_save_delay = 0 } end ,
--             {description = &#34take screenshot&#34, group = &#34client&#34}),
--         awful.key({&#34Shift&#34}, &#34Print&#34,
--             function () saved_screenshot { auto_save_delay = 0, interactive = true } end ,
--             {description = &#34take interactive screenshot&#34, group = &#34client&#34}),
--         awful.key({&#34Control&#34}, &#34Print&#34,
--             function () delayed_screenshot { auto_save_delay = 5 } end ,
--             {description = &#34take screenshot in 5 seconds&#34, group = &#34client&#34}),
--         awful.key({&#34Shift&#34, &#34Control&#34}, &#34Print&#34,
...
-- 
--
--<object class=&#34img-object&#34 data=&#34../images/AUTOGEN_awful_screenshot_popup.svg&#34 alt=&#34Usage example&#34 type=&#34image/svg+xml&#34></object>
--
-- 
--     awful.popup {
...
--                     ib.valign = &#34center&#34
--                     ib.halign = &#34center&#34
--                     self:get_children_by_id(&#34screenshot&#34)[1].widget = ib
--                 end,
--             },
--         },
