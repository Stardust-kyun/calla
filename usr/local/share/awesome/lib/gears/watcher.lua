...
-- 
--
--<object class=&#34img-object&#34 data=&#34../images/AUTOGEN_text_gears_watcher_simple.svg&#34 alt=&#34Usage example&#34 type=&#34image/svg+xml&#34></object>
--
-- @usage
--     local mybatterydischarging = gears.watcher {
--         file     = &#34/sys/class/power_supply/BAT0/status&#34,
--         interval = 5,
--     }
--
-- @property file
...
-- 
--
--<object class=&#34img-object&#34 data=&#34../images/AUTOGEN_text_gears_watcher_files1.svg&#34 alt=&#34Usage example&#34 type=&#34image/svg+xml&#34></object>
--
-- 
--     local mybatterycharging = gears.watcher {
--         files    = {
--             &#34/sys/class/power_supply/AC/online&#34,
--             &#34/sys/class/power_supply/BAT0/status&#34
--         },
--         filter   = function(content)
--             return content['/sys/class/power_supply/AC/online'  ] == &#341&#34
--                 or content['/sys/class/power_supply/BAT0/status'] == &#34Full&#34
--         end,
--         interval = 5,
--     }
--
...
-- 
--
--<object class=&#34img-object&#34 data=&#34../images/AUTOGEN_text_gears_watcher_files2.svg&#34 alt=&#34Usage example&#34 type=&#34image/svg+xml&#34></object>
--
-- 
--     local mybatterycharging = gears.watcher {
--         files    = {
--             plugged = &#34/sys/class/power_supply/AC/online&#34,
--             charged = &#34/sys/class/power_supply/BAT0/status&#34
--         },
--         filter   = function(content)
--             return content.plugged == &#341&#34 or content.charged == &#34Full&#34
--         end,
--         interval = 5,
--     }
--
...
--         interval = 0.05,
--         command  = &#34echo one two three&#34,
--     }
--      
--     -- [wait some time]
--      
--     -- It will be &#34one two three&#34
--     print(w.value)
--
-- @property command
...
--     local w = gears.watcher {
--         interval = 0.05,
--         command  = &#34echo one two three | cut -f3 -d ' '&#34,
--         shell    = true,
--     }
--      
--     -- [wait some time]
--      
--     -- It will be &#34three&#34
--     print(w.value)
---
-- @property shell
...
-- 
--
--<object class=&#34img-object&#34 data=&#34../images/AUTOGEN_wibox_widget_declarative_watcher.svg&#34 alt=&#34Usage example&#34 type=&#34image/svg+xml&#34></object>
--
-- 
...
--         interval             = 5,
--         files                = {
--             capacity = &#34/sys/class/power_supply/BAT0/energy_full&#34,
--             current  = &#34/sys/class/power_supply/BAT0/energy_now&#34
--         },
...
--             return (battery.current / battery.capacity) .. &#34%&#34
--         end),
